...
if ($partes_ruta[0] == 'Pagina') {
    if (count($partes_ruta) == 1) {
        ...
        if ($partes_ruta[1] == 'entrada') {
            ...
            if ($entrada != null) {
                $autor = RepositorioUsuario::obtenerUsuarioPorId(Conexion::obtenerConexion(),$entrada->obtenerAutorId());
                $comentarios = RepositorioComentario::obtenerComentarios(Conexion::obtenerConexion(),$entrada->obtenerId());
                $entradas_al_azar=RepositorioEntrada::obtenerEntradasAlAzar(Conexion::obtenerConexion(),3);
